...
namespace EMK.Cartography
{
	...
	public class AStar
	{
		...
		SortableList.Equality SameNodesReached = Track.SameEndNode;

		/// <summary>
		/// Heuristic based on the assigned distance
		/// </summary>
		public static Heuristic AssignedDistanceHeuristic => Node.AssignedDistance;
